...
/**
 * Elementor 'RecentPostsLand' widget.
 *
 * Elementor widget that displays an 'RecentPostsLand' with lightbox.
 *
 * @since 1.0.0
 */
class RecentPostsLand extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve 'RecentPostsLand' widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'aux_recent_posts_land_style';
    }

    /**
     * Get widget title.
     *
     * Retrieve 'RecentPostsLand' widget title.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     * Get widget icon.
     *
     * Retrieve 'RecentPostsLand' widget icon.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_icon() {
        return 'eicon-post-list auxin-badge';
    }
    ...
    /**
     * Register 'RecentPostsLand' widget controls.
     *
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .entry-meta a, {{WRAPPER}} .entry-meta, {{WRAPPER}} .entry-meta span' => 'color: {{VALUE}}; border-color: {{VALUE}};',
                )
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .entry-meta a:hover, {{WRAPPER}} .entry-meta span:hover' => 'color: {{VALUE}}; border-color: {{VALUE}};',
                )
            )
        );
  ...
  protected function render() {
    ...
    echo auxin_widget_recent_posts_land_style_callback( $args );
